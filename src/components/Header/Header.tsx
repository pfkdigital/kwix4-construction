...
import kitchen from "@/../public/kitchen-renovation.webp"
            ...
            <div className="relative flex items-center justify-center w-full h-screen text-center">
                ...
                <div className="z-10 px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <motion.h1
                            className="mb-6 text-4xl font-bold leading-10 tracking-tight text-gray-50 md:text-6xl"
                        ...
                        >
                        <motion.h2
                            className="mb-6 tracking-wide font-bold text-white sm:mt-5 sm:text-md sm:max-w-xl sm:mx-auto md:mt-5"
                            initial={shouldAnimate ? "hidden" : {}}
                            animate={shouldAnimate ? "visible" : {}}
                            transition={{duration: 0.8, type: "spring"}}
                            variants={fadeInSub}>
