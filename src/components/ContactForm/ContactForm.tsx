...
import {handleData} from "@/utilities/send-contact-form";
...
const ContactForm = () => {
    ...
    const handleSubmit = async (e: ChangeEvent<HTMLFormElement>) => {
        e.preventDefault()
        await handleData(formData).then(() => {
                ...
                <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-10 md:px-7">
                    ...
                    <div className="flex justify-center flex-wrap mb-8 -mx-4">
                        ...
                        <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                            <div
                                className="h-full py-12 text-center transition-all rounded-lg shadow bg-gray-50  hover:shadow-lg">
                                <div
                                    className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-orange-500 rounded-full ">
                                    <svg
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex flex-wrap mb-4 -mx-2">
                                <div className="w-full px-2 mb-4 lg:mb-0 lg:w-1/2">
                                    <input
                                        className="w-full px-3 py-2 leading-loose border rounded-md bg-gray-50 text-gray-500 "
                                        type="text"
                            ...
                            {/* Email Input */}
                            <input
                                className="w-full px-3 py-2 mb-4 leading-loose border rounded-md bg-gray-50 text-gray-500 "
                                type="email"
                            ...
                            <textarea
                                ...
                                name="message"
                                onChange={handleChange}
                                className="block w-full px-4 mb-4 leading-tightborder rounded bg-gray-50  py-7 text-gray-500 "
                            ></textarea>

                            {/* Send Message Button */}
                            <button
                                className="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-orange-600 rounded-md  hover:bg-orange-700"
                                type="submit">
                                Send Message
                            </button>
                        </form>
